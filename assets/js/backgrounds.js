(function() {
  ...
  var locations = [
    ...
    { id: 'annarbor', label: 'Ann Arbor', timeZone: 'America/New_York', latitude: 42.2808, longitude: -83.7430, alertProvider: 'nws', mobileBackgroundPosition: '26% center', active: true },
    ...
    { id: 'sansebastian', label: 'San Sebastian', timeZone: 'Europe/Madrid', latitude: 43.3183, longitude: -1.9812, mobileBackgroundPosition: '85% center', active: true },
  ...
  function openMenu(focusCurrent) {
    ...
    if (primaryNav && mobileMenuQuery.matches) {
  ...
  mobileMenuQuery.addEventListener('change', function() {
    ...
    if (menu.classList.contains('is-visible') && mobileMenuQuery.matches) {
      primaryNav.setAttribute('aria-hidden', 'true');
      primaryNav.setAttribute('inert', '');
      return;
    }
